...
/**
 * Creates a Stripe invoice for an order with enhanced debugging
 */
export async function createStripeInvoiceForOrder(
  ...
  try {
    ...
    // Ensure Stripe customer exists with proper billing address
...
/**
 * Re-invoices an unpaid order with enhanced debugging
 */
